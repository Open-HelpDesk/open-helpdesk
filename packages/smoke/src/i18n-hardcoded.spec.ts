 ...
 *
 * This check exists because the mistake was made at scale: a hundred and
 * forty-eight strings were written straight into the code — the whole
 * automations screen, the whole onboarding, the article templates, the report
 * CSV headers. They stayed in one language whatever the workspace was set to,
...
// EE code lives outside apps/web but drives the same screens: same rule.
